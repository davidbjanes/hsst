...
switch char(handles.datatype)
    ...
    case 'ASCII'            % ASCII matlab files
        %DAB194 EDIT
%         temp_var_pathname = 'C:\dab194\Dropbox\Code\RNEL Projects\Spike Sorting Evaluation\WaveClus_dataset\Simulator';
%         pathname = temp_var_pathname;
%         filename = 'C_Easy2_noise02.mat';    
...
%DAB194 EDIT
% save_clusters_button_Callback([], [], handles);
...
%DAB194EDIT
% temp_path = 'C:\dab194\Dropbox\Code\RNEL Projects\Spike Sorting Evaluation\GENERATED_WC_RESULTS2';
% outfile=[temp_path '\times_' par.filename(1:end-4) '_' sprintf('N%2.0f', round((rand()*100))-1)];
